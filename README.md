...
### Search
Performs a search using the Tavily search engine.

### Parse SBOM
Parses a Software Bill of Materials (SBOM) and extracts framework information.

### Check EOL Dates
Checks the end-of-life (EOL) dates of frameworks and suggests upgrades if necessary.